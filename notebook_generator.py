        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "else:\n",
                    "    print(f'✅ SOTA Hub already active. Updating remote and checking sync state...')\n",
                    "    subprocess.run(['git', 'remote', 'set-url', 'origin', hub_url], cwd=hub_root)\n",
                    "    # 2026 Resilience: Fetch first to ensure origin/main tracking is accurate\n",
                    ...
                    "\n",
                    "if check_dirty.returncode != 0 or ahead_count > 0:\n",
                    ...
                    "    if res.returncode != 0:\n",
                    "        print('🔄 Divergence detected. Attempting rebase recovery...')\n",

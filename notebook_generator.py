...
def build_training_notebook_content(model_key, config=None):
    ...
    ds_keys_repr = repr([model_key.lower(), model_key.replace("_", "-"), model_key.replace("_", "")] + (["forex", "lemgendizedforextitancorelarge", "lemgendizedforexg7majorslarge", "lemgendizedforexhighbetalarge", "lemgendizedforexuniverselarge"] if is_forex else []))
...
def build_colab_training_notebook_content(model_key, config=None):
    ...
    is_forex = "forex" in model_key.lower()
    colab_ds_keys_repr = repr([model_key.lower(), model_key.replace("_", "-"), model_key.replace("_", "")] + (["forex", "lemgendizedforextitancorelarge", "lemgendizedforexg7majorslarge", "lemgendizedforexhighbetalarge", "lemgendizedforexuniverselarge"] if is_forex else []))
